...
CPATH="$CPATH:config"
CPATH="$CPATH:config/client"
CPATH="$CPATH:config/vtest"
...
PROPS="$PROPS -Dcom.sun.management.jmxremote"
PROPS="$PROPS -Dcom.sun.management.jmxremote.port=1198"
PROPS="$PROPS -Dcom.sun.management.jmxremote.authenticate=false"
PROPS="$PROPS -Dcom.sun.management.jmxremote.ssl=false"
PROPS="$PROPS -Djava.rmi.server.hostname=localhost"
