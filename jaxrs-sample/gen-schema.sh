...
classes="$sdir2/Location.java $sdir2/Offer.java $sdir2/BaseObject.java $sdir2/OfferList.java $sdir2/Store.java $sdir2/StoreList.java $sdir1/PagedList.java $sdir1/Link.java $sdir2/Error.java"
odir=tmp
