...
public class KeyStringValueShell {
	private static final Logger logger = Logger.getLogger(KeyStringValueShell.class);
    ...
    private KeyStringValueDao keyValueDao;

	public static void main(String [] args) throws IOException {
		(new KeyStringValueShell()).process(args);
	}
	...
	void put(String [] tokens) throws Exception { 
		...
		KeyStringValue keyValue = new KeyStringValue(key);
    ...
    void putFile(String [] tokens) throws Exception {
        ...
        if (!file.exists()) {
            ...
            String value = new String(Files.toByteArray(file));
			KeyStringValue keyValue = new KeyStringValue(key);
			keyValue.setValue(value);
			keyValueDao.put(keyValue);
        }
...
/*
	private KeyStringValue newKeyValue(String key, int n) {
		KeyStringValue keyValue = new KeyStringValue(key);
...
*/
    ...
    private void initSpring() {
        ...
        keyValueDao = context.getBean("keyStringValueDao",KeyStringValueDao.class);
